...
<body class="hold-transition login-page" style="background-color: #667b68;">
  <div class="login-box" style="min-width: 55% !important; ">
    ...
    <div class="card">
      <div class="card-body login-card-body" style="border-radius: 10px;">
        ...
        <div class="login-logo">
          <div class="row">
            <div class="col-md-3">
              <img src="<?= base_url('assets/upload/image/Logo Unand.png') ?>" class="img img-fluid">
            </div>
            <div class="col-md-9 text-left">
              <h1>Laporan Kerusakan Fasilitas di Gedung Perkuliahan</h1>
              <p style="font-size: 12px; font-weight: bold;">Universitas Andalas</p>
            </div>
          </div>
        </div>
        <hr>
